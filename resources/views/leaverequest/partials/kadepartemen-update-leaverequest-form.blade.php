<section>
    <form method="post" action="{{ route('kadepartemen.leave-request.edit', $data['idLR']) }}" class="space-y-6">
        @csrf
            <div>
            ...
            <x-text-input id="isAcceptedKahrd" name="isAcceptedKahrd" value="{{ $data['isAcceptedKahrd'] }}" type="hidden" class="mt-1 block w-full" />
